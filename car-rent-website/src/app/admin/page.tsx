...
{/* Sport Car */}
                  ...
                  <h1 className={`${PlusJakartaSans600.className} text-[14px] text-[#90A3BF] ml-2`}>Sports Cars</h1></div>
...
{/* SUV */}
                  ...
                  <h1 className={`${PlusJakartaSans600.className} text-[14px] text-[#90A3BF] ml-2`}>SUV</h1></div>
                  ...
                  <h1 className={`${PlusJakartaSans600.className} text-[14px] text-[#90A3BF] ml-2`}>Coupe</h1></div>
                  ...
                  <h1 className={`${PlusJakartaSans600.className} text-[14px] text-[#90A3BF] ml-2`}>Hatchback</h1></div>
                  ...
                  <h1 className={`${PlusJakartaSans600.className} text-[14px] text-[#90A3BF] ml-2`}>MPV</h1></div>
